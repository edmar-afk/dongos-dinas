...
export default function AgeSexDistribution() {
  ...
  const purokLabels = [
    "0.5 mos. old",
    "6 mos. - 1 year and 11 mos. old",
    "2-4 years and 11 mos. old",
    "5-5 years and 11 mos. old",
    "6-12 years old",
    "13-20 years old",
    "21-59 years old",
    "60 years old and above",
    "Young dependents (0-14)",
    "Old dependents (65 & above)",
    "Labor force (15-64)",
  ];

  const maleData = [3, 21, 23, 6, 87, 86, 293, 53, 140, 13, 298];
  const femaleData = [5, 11, 15, 4, 54, 90, 252, 73, 189, 19, 143];
