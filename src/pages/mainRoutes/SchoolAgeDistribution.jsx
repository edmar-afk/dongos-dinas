...
export default function SchoolAgeDistribution() {
  ...
  const ethnicLabels = [
    ...
    "Junior High School age (13-16)",
    "Senior High School age (17-18)",
    "Tertiary School age (19-23)",
  ];

  const populationData = [482, 300, 66, 88];
